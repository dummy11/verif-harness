...
class DashboardTest(unittest.TestCase):
    ...
    def test_html_is_local_layered_and_snapshot_is_detailed(self) -> None:
        ...
        self.assertIn("快速查看需要你处理的事项", html)
        ...
        self.assertNotIn("overviewTile('agent'", html)
        self.assertIn("overviewTile('pending', '需要你处理'", html)
        ...
        self.assertIn("所有计划要求的文档交付节点均已批准（暂定不计）", html)
